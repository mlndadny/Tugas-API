                ...
                <div class="row mt-4">
                    <div class="col-12">
                      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link <?php echo e(($key == 'home') ? 'active' : ''); ?>" id="v-pills-home-tab" href="/home">Home</a>
                        <a class="nav-link <?php echo e(($key == 'rental') ? 'active' : ''); ?>" id="v-pills-profile-tab" href="/rental">Rental PS</a>
...
<?php /**PATH C:\Users\Lenovo\Desktop\Z_MEME\resources\views/layouts/main.blade.php ENDPATH**/ ?>