          ...
          <div class="col-md-12 bg-primary py-2">
            <div class="dropdown float-right">
              ...
              <div class="dropdown-menu" dropdown-menu-right aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#">Steven Alvaro</a>
                ...
                <div class="row mt-4">
                    <div class="col-3">
                      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link <?php echo e(($key == "pet") ? "active":""); ?>" id="v-pills-profile-tab" href="/pet">PET</a>
...
</html><?php /**PATH C:\Users\User\Desktop\movieapp\resources\views/layouts/main.blade.php ENDPATH**/ ?>